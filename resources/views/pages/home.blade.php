    ...
    <section class="st-hero st-style2 st-bg st-dynamic-bg st-ripple-version"
        ...
        <div class="container">
            <div class="st-hero-text">
                <div class="st-author"><img src="{{ asset('assets2/img/section/hero-img.jpg') }}" alt=""></div>
                <h1>Hi, I am <span>Abhinav Kapila</span></h1>
                <p>Hello! I'm Abhinav Kapila, a passionate Interactive Media Designer and Video Editor with 4 years of
                    experience. I excel at transforming ideas into engaging multimedia content through creative visual
                    storytelling.</p>
                <div class="st-hero-social-links">
                    <a href="https://www.behance.net/abhinavdesignhub" target="_blank" class="st-social-btn">
                        <img src="https://logos-world.net/wp-content/uploads/2022/04/Behance-Emblem.png" </a>
                        ...
                        <div class="st-vertical-middle-in">
                            <div class="st-text-block st-style1">
                                ...
                                <div class="st-text-block-text">
                                    <p> A passionate Interactive Media Designer and Video Editor with 4 years of experience.
                                        I
                                        excel at transforming ideas into engaging multimedia content through creative visual
                                        storytelling. My expertise spans designing interactive user interfaces and editing
                                        impactful videos, always with meticulous attention to detail.
                                        I thrive on collaboration, working closely with teams to refine and enhance
                                        projects. Whether you're looking for innovative design or skilled video editing, I'm
                                        excited to contribute to your creative projects through Abhinav Design Hub.
                                    </p>
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <a href="/details" class="serices-text">
                        ...
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">Print Design</h2>
                            {{-- <div class="st-iconbox-text">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor
                                sittem elit inuning utsed sittem.</div> --}}
                        </div>
                        <div class="st-height-b30 st-height-lg-b30"></div>
                ...
                <div class="col-lg-4 col-md-6">
                    <a href="/details" class="serices-text">
                        ...
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">Digital/Web Design</h2>
                            {{-- <div class="st-iconbox-text">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor
                                sittem elit inuning utsed sittem.</div> --}}
                        </div>
                        <div class="st-height-b30 st-height-lg-b30"></div>
                ...
                <div class="col-lg-4 col-md-6">
                    <a href="/details" class="serices-text">
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">Illustration </h2>
                            {{-- <div class="st-iconbox-text">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor
                                sittem elit inuning utsed sittem.</div> --}}
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-md-6">
                    <a href="/details" class="serices-text">
                        ...
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">Advertising</h2>
                            {{-- <div class="st-iconbox-text">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor
                                sittem elit inuning utsed sittem.</div> --}}
                        </div>
                        <div class="st-height-b30 st-height-lg-b30"></div>
                ...
                <div class="col-lg-4 col-md-6">
                    <a href="/details" class="serices-text">
                        ...
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">Editorial Design</h2>
                            {{-- <div class="st-iconbox-text">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor
                                sittem elit inuning utsed sittem.</div> --}}
                        </div>
                        <div class="st-height-b30 st-height-lg-b30"></div>
                ...
                <div class="col-lg-4 col-md-6">
                    <a href="/details" class="serices-text">
                        ...
                        <div class="st-iconbox st-style1">
                            ...
                            <h2 class="st-iconbox-title">Packaging Design</h2>
                            {{-- <div class="st-iconbox-text">Lorem ipsum dolor sittem ametamn elit, per sed do eiusmoad teimpor
                                sittem elit inuning utsed sittem.</div> --}}
                        </div>
                        <div class="st-height-b30 st-height-lg-b30"></div>
                    ...
                    <div class="st-progressbar-wrap">
                        <div class="st-single-progressbar">
                            <div class="st-progressbar-heading">
                                <h3 class="st-progressbar-title">Adobe Photoshop</h3>
                                <div class="st-progressbar-percentage wow fadeInLeft d-block" data-wow-duration="1.5s"
                                    data-wow-delay="0.5s">95%</div>
                            </div>
                            <div class="st-progressbar d-block" data-progress="95">
                        ...
                        <div class="st-single-progressbar">
                            <div class="st-progressbar-heading">
                                <h3 class="st-progressbar-title">Adobe Illustrator</h3>
                        ...
                        <div class="st-single-progressbar">
                            <div class="st-progressbar-heading">
                                <h3 class="st-progressbar-title">Adobe InDesign</h3>
                                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s"
                        ...
                        <div class="st-single-progressbar">
                            <div class="st-progressbar-heading">
                                <h3 class="st-progressbar-title">Adobe After Effects</h3>
                                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s"
                        ...
                        <div class="st-single-progressbar">
                            <div class="st-progressbar-heading">
                                <h3 class="st-progressbar-title">Adobe Premiere Pro</h3>
                                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s"
                        ...
                        <div class="st-single-progressbar">
                            <div class="st-progressbar-heading">
                                <h3 class="st-progressbar-title">HTML + CSS + Javascript</h3>
                                <div class="st-progressbar-percentage wow fadeInLeft" data-wow-duration="1.5s"
                                    data-wow-delay="0.5s">90%</div>
                            </div>
                            <div class="st-progressbar" data-progress="90">
                        ...
                        <div class="slick-slide-in">
                            <div class="st-post-single st-style1">
                                <a class='st-post-thumb st-zoom' href='/about'>
                                    <img src="assets2/img/blog/blog1.jpg" class="st-zoom-in" alt="blog1">
                                </a>
                            </div>
                        </div>
                        <div class="slick-slide-in">
                            <div class="st-post-single st-style1">
                                <a class='st-post-thumb st-zoom' href='/about'>
                                    <img src="assets2/img/blog/blog2.jpg" class="st-zoom-in" alt="blog2">
                                </a>
                            </div>
                        </div>
                        <div class="slick-slide-in">
                            <div class="st-post-single st-style1">
                                <a class='st-post-thumb st-zoom' href='/about'>
                                    <img src="assets2/img/blog/blog3.jpg" class="st-zoom-in" alt="blog3">
                                </a>
                            </div>
                        </div>
                        <div class="slick-slide-in">
                        ...
                        <div class="st-resume-timeline-wrap">
                            <div class="st-resume-timeline">
                                ...
                                <div class="st-resume-timeline-text">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc ligula nulla, tincidunt
                                        id faucibus sed, suscipit feugiat turpis.</p>
                                </div>
                            </div>
